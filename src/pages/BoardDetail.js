...
const BoardDetail = (props) => {
    ...
    const getDetailReply = useCallback((page=1)=>{
        setCurrentPage(page);
        axios.get(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments`,{
            params:{
                _page:page,
                _limit:10
            }
    ...
    const getDetail = useCallback((page=1)=>{
        axios.get(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/${isBoardAdmin?'adminPosts':'posts'}/${props.match.params.id}`)
        .then((res)=>{
            setPost(res.data);
    ...
    const detailReply = ()=>{
        ...
        axios.get(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments`)
            .then((res) => {
                ...
                axios.post(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments`, {
                    text,
                    date: formattedDate,
                    email: user.email,
                    postId,
    ...
    const thumbUp = (e, reply)=>{
        ...
        axios.get(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments/${reply.id}`).then((res)=>{
                ...
                setIsThumbUp(true)
                axios.put(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments/${reply.id}`,{
                    text: reply.text,
                    date: reply.date,
                    email: reply.email,
                    postId,
    ...
    const deletePost = (e,id)=>{
        e.stopPropagation();
        axios.delete(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/${isBoardAdmin?'adminPosts':'posts'}/${id}`).then(()=>{
            toast_add({
    ...
    const replyModifyBtn = (v)=>{
        axios.put(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments/${v.id}`,{
    ...
    const replyDelete = (id)=>{
        console.log(id);
        axios.delete(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/comments/${id}`).then((res)=>{
            getDetailReply();
            toast_add({
                text:'댓글 삭제 완료',
                type:'success',
    ...
    const postUp = (e,id)=>{
        ...
        axios.get(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/${isBoardAdmin?'adminPosts':'posts'}/${id}`).then((res)=>{
            ...
            setIsPostUp(true)
                axios.put(`https://moduportfolio-09b6894bf3f7.herokuapp.com/api/${isBoardAdmin?'adminPosts':'posts'}/${id}`,{
                    title,
                    body,
                    category,
                    date,
